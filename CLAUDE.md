...
1. **交接文檔**: `.claude/HANDOVER.md` - 專案背景、進度、下一步
2. **開發規格**: `docs/DEVELOPMENT_SPEC.md` - 完整技術規格
3. **設計系統**: `.claude/skills/frontend-design/resources/design-tokens.md`
...
| 主題 | 位置 | 說明 |
|-----|------|------|
| **交接文檔** | `.claude/HANDOVER.md` | 專案背景與進度 |
